...
namespace Sellsys.WpfClient.Services
{
    public class ApiService
    {
        ...
        public async Task<Department> CreateDepartmentAsync(DepartmentUpsertDto departmentDto)
        {
            try
            {
                var response = await _httpClient.PostAsJsonAsync($"{BaseUrl}/departments", departmentDto);
                response.EnsureSuccessStatusCode();
        ...
        public async Task<DepartmentGroup> CreateDepartmentGroupAsync(DepartmentGroupUpsertDto groupDto)
        {
            try
            {
                var response = await _httpClient.PostAsJsonAsync($"{BaseUrl}/departmentgroups", groupDto);
                response.EnsureSuccessStatusCode();
